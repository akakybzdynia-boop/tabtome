...
The uninstaller always removes program files and the Firefox and Chrome/Chromium registrations. User data is retained by default and deleted only after a separate explicit confirmation.
