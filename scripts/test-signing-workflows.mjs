...
const prepareBuildTools = read("installer/prepare-build-tools.ps1");
...
assert.match(prepareBuildTools, /Start-Process -FilePath \$iscc -ArgumentList "\/\?"/);
assert.doesNotMatch(prepareBuildTools, /& \$iscc \/\?/);
